...
\begin{multicols}{2}
  ...
  \infrule[pr]{
    ...
    i \star [ \Gamma ] \vdash ! e\ \colon !_i B
  }
  ...
  \infrule[fix]{
    [ \Gamma ] , x\ \colon [ A ]_i \vdash e\ \colon A \hspace{15pt} 1 + i \star j \preceq j
  }{
    j \star [ \Gamma ] \vdash \mbox{fix}\ x.e\ \colon A
  }

  \infrule[let]{
    \Gamma \vdash e\ \colon !_i A \hspace{15pt} \Delta , x\ \colon [ A ]_i \vdash e'\ \colon B
  }{
